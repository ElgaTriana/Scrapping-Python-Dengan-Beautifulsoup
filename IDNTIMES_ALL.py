...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/health')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES HEALTH")
...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/hype')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES HYPE")
...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/life')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES LIFE")
...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/sport')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES SPORT")
...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/tech')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES TECH")
...
cursor = db.cursor()
url = requests.get('https://www.idntimes.com/travel')
soup = BeautifulSoup(url.text, 'html.parser')
articles = soup.find(id="latest-article").find_all(class_="box-latest")
# articles = soup.find(class_="list-latest").find_all(class_="description-latest")
link_articles = soup.find(class_="list-latest").find_all(class_="box-latest")
...
print("BERHASIL SCRAPPING IDNTIMES TRAVEL")